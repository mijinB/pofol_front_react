...
interface IActivitySkillsProps {
    isITBook?: boolean;
...
function ActivitySkills({ isITBook, isTypeScript, isCSS, isReact, isJavaScript, isFlutter }: IActivitySkillsProps) {
    return (
        <>
            {isITBook && (
                <TagContainer>
